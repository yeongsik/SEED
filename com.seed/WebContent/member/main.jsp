...
<c:if test="${sessionScope.id != null }">
	...
	<a href="<%=request.getContextPath()%>/LiveAddActionForm.seed">글쓰기</a><br><br>
	<a href="<%=request.getContextPath()%>/LiveListAction.seed">글목록</a><br><br>
...
<!-- 세션이 없는 경우-->
<c:if test="${sessionScope.id == null }">
	<a href="<%=request.getContextPath()%>/LiveListAction.seed">글목록</a>
