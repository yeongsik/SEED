...
<body>
	<form  action="<%=request.getContextPath() %>/TipAddAction.seed" method="post" ><!-- enctpye:첨부파일 사용시 추가.  enctype="multipart/form-data"-->
		<div style="width:600px;height: 500px; border: solid 1px;">
			<div>글작성</div>
			<div>
			...
			<div>
				...
				<div style="display: inline-block;"><textarea id="board_content" name="board_content" cols="50" rows="20"></textarea></div>
			</div>
